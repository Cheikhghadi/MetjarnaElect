...
const registerUser = async (req, res, next) => {
  ...
  try {
    ...
    try {
      ...
      res.status(500);
      throw new Error("Compte créé, mais nous n'avons pas pu envoyer le code de vérification. Veuillez réessayer ou utiliser le code de test si vous êtes en développement.");
    }
